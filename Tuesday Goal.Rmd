...
```{r}
scores <- read_excel("C:/Users/Ayush/Documents/GitHub/DS-5110-Group-Project/data/CO/2017-2018/2018 PARCC data.xlsx")

absentism <- read_excel("C:/Users/Ayush/Documents/GitHub/DS-5110-Group-Project/data/CO/2017-2018/Chronically Absent by District 2017-18xls.xlsx")

scores <- scores %>%
  filter(District_Name != "All Districts",School_Name == "All Schools",
         Content == "English Language Arts", Test_Grade == "All Grades",
...
```{r }
turnover <- read_excel("C:/Users/Ayush/Documents/GitHub/DS-5110-Group-Project/data/CO/2017-2018/2017-18 Personnel Turnover Rate by District and Position Categories.xlsx")

turnover <- turnover%>%filter(Job_Classification == 'Teachers',!is.na(Turnover_Rate))%>%
            transmute(Retention_Rate = (1-Turnover_Rate) * 100,District_Name=District_Name)
...
"C:/Users/Ayush/Documents/GitHub/DS-5110-Group-Project/data/CO/2017-2018/Discipline by Gender 2017-18 Corrected.xlsx")
...
scores %>% 
  ...
  mutate(DiscRatio = (Suspensions/as.numeric(Valid_Scores)) * 100)%>%
...
```{r}
budget <- read_excel(
"C:/Users/Ayush/Documents/GitHub/DS-5110-Group-Project/data/CO/2017-2018/RescissionsFY2017-18 with Per Pupil Funding.xls")
...
salaries <- read_excel(
"C:/Users/Ayush/Documents/GitHub/DS-5110-Group-Project/data/CO/2017-2018/2017-18 Average Salaries for Teachers.xlsx")


scores%>%
  left_join(salaries, by = 'District_Name') %>%
  ggplot() + geom_point(aes(x = as.numeric(Average_Salary),
                      y = as.numeric(Percent_Met_or_Exceeded_Expectations))) +
    scale_y_continuous() +
...
```{r}
stratios <- read_excel(
"C:/Users/Ayush/Documents/GitHub/DS-5110-Group-Project/data/CO/2017-2018/2017-18 Student Teacher Ratios.xlsx")
