...
- Truancy (transformed respone variable with sqrt())
- Teacher Retention (no pattern found)
- Suspensions
- Budget per student (no real pattern, but maybe something with underperforming students rather than 4-5 proficient)
- Teacher Salary
